...
define_field!(modulus = "2013265921", generator = "31", name = BabyBear,);

// KoalaBear: p = 2^31 - 2^24 + 1, TWO_ADICITY = 24
define_field!(modulus = "2130706433", generator = "3", name = KoalaBear,);
...
define_field!(modulus = "3221225473", generator = "5", name = TeddyBear,);
